...
FEATURE_DESCRIPTIONS: dict[FeatureName, str] = {
    ...
    FeatureName.characters: "Immersive character cards and persona context.",
    FeatureName.external_model: "OpenAI-compatible external model rendering.",
    FeatureName.rp_memory: "Immersive scene memory storage and retrieval.",
    FeatureName.secretary_memory: "Practical-posture user preference memory.",
...
class CapabilityReport(KernelModel):
    ...
    agent_tools: dict[str, list[str]] = Field(default_factory=dict, alias="agentTools")
