...
- Each initial or follow-up run persists a fenced owner claim, bounded transcript checkpoints, cumulative usage, and a write-ahead tool intent/result journal under its frozen budgets. External or metered calls require an explicit replay decision. An interrupted non-terminal job still fails closed on startup until recovery can reconcile that journal safely.
