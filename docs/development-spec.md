...
| GET | `/api/v1/model-providers` | List safe loaded-adapter descriptors, declarative configuration fields, and diagnostic capabilities without selected values, credentials, or executable definitions |
